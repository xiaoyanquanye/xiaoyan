...
@interface Hamu2ViewController ()<UITableViewDataSource,UITableViewDelegate>{
...
@implementation Hamu2ViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.section==0) {
        ...
        image1.image=[UIImage imageNamed:@"215"];
    ...
    if (indexPath.section==1) {
        ...
        image2.image=[UIImage imageNamed:@"216"];
    ...
    if (indexPath.section==2) {
        ...
        image2.image=[UIImage imageNamed:@"217"];
        [_tableview addSubview:image2];
    ...
    if (indexPath.section==3) {
        ...
        image3.image=[UIImage imageNamed:@"218"];
    ...
    if (indexPath.section==4) {
        ...
        image4.image=[UIImage imageNamed:@"219"];
    ...
    if (indexPath.section==5) {
        ...
        image5.image=[UIImage imageNamed:@"220"];
