...
@interface Hagong1ViewController ()<UITableViewDataSource,UITableViewDelegate>{
...
@implementation Hagong1ViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.section==0) {
        ...
        image1.image=[UIImage imageNamed:@"72"];
    ...
    if (indexPath.section==1) {
        ...
        image2.image=[UIImage imageNamed:@"73"];
    ...
    if (indexPath.section==2) {
        ...
        image2.image=[UIImage imageNamed:@"74"];
        [_tableview addSubview:image2];
    ...
    if (indexPath.section==3) {
        ...
        image3.image=[UIImage imageNamed:@"75"];
    ...
    if (indexPath.section==4) {
        ...
        image4.image=[UIImage imageNamed:@"76"];
    ...
    if (indexPath.section==5) {
        ...
        image5.image=[UIImage imageNamed:@"77"];
