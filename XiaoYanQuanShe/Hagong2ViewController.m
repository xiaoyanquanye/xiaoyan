//
//  Hagong2ViewController.m
//  XiaoYanQuanShe
//
//  Created by guo xiangyu on 5/5/17.
//  Copyright © 2017年 潇  岩. All rights reserved.
//

#import "Hagong2ViewController.h"

@interface Hagong2ViewController ()<UITableViewDataSource,UITableViewDelegate>{
...
@implementation Hagong2ViewController
...
- (void)viewDidLoad {
    ...
    imgArray=@[@"125",@"126",@"127",@"128",@"129",@"130"];
    // Do any additional setup after loading the view.
}

//- (NSString *)tableView:(UITableView *)tableView titleForHeaderInSection:(NSInteger)section{//页头
//    
//    return @"你好";
//}
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section {//页头设计
    ...
    headerLabel.text=@"出生日期：2014年7月7日           AKC注册号: ZG52077581            CKU注册号：CKU-270318110/77          繁殖者: 潇岩                                 训练师：杨聚财                          所有权所在犬舍:潇岩犬舍  ";
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    image1.image=[UIImage imageNamed:@"125"];
    ...
    if (indexPath.section==1) {
        ...
        image2.image=[UIImage imageNamed:@"126"];
    ...
    if (indexPath.section==2) {
        ...
        image2.image=[UIImage imageNamed:@"127"];
        [_tableview addSubview:image2];
    ...
    if (indexPath.section==3) {
        ...
        image3.image=[UIImage imageNamed:@"128"];
    ...
    if (indexPath.section==4) {
        ...
        image4.image=[UIImage imageNamed:@"129"];
    ...
    if (indexPath.section==5) {
        ...
        image5.image=[UIImage imageNamed:@"130"];
    ...
    if (indexPath.section==6) {
        ...
        image6.image=[UIImage imageNamed:@"131"];
