...
@interface Chaimu3ViewController ()<UITableViewDataSource,UITableViewDelegate>{
...
@implementation Chaimu3ViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.section==0) {
        ...
        image1.image=[UIImage imageNamed:@"181"];
    ...
    if (indexPath.section==1) {
        ...
        image2.image=[UIImage imageNamed:@"182"];
    ...
    if (indexPath.section==2) {
        ...
        image2.image=[UIImage imageNamed:@"183"];
        [_tableview addSubview:image2];
    ...
    if (indexPath.section==3) {
        ...
        image3.image=[UIImage imageNamed:@"184"];
    ...
    if (indexPath.section==4) {
        ...
        image4.image=[UIImage imageNamed:@"185"];
    ...
    if (indexPath.section==5) {
        ...
        image5.image=[UIImage imageNamed:@"186"];
    ...
    if (indexPath.section==6) {
        ...
        image6.image=[UIImage imageNamed:@"187"];
