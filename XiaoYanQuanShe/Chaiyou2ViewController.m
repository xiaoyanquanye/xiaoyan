...
@interface Chaiyou2ViewController ()<UITableViewDataSource,UITableViewDelegate>{
...
@implementation Chaiyou2ViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.section==0) {
        ...
        image1.image=[UIImage imageNamed:@"272"];
    ...
    if (indexPath.section==1) {
        ...
        image2.image=[UIImage imageNamed:@"273"];
    ...
    if (indexPath.section==2) {
        ...
        image2.image=[UIImage imageNamed:@"274"];
        [_tableview addSubview:image2];
    ...
    if (indexPath.section==3) {
        ...
        image3.image=[UIImage imageNamed:@"275"];
    ...
    if (indexPath.section==4) {
        ...
        image4.image=[UIImage imageNamed:@"276"];
    ...
    if (indexPath.section==5) {
        ...
        image5.image=[UIImage imageNamed:@"277"];
