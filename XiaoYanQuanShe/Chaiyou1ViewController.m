...
@interface Chaiyou1ViewController ()<UITableViewDataSource,UITableViewDelegate>{
...
@implementation Chaiyou1ViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.section==0) {
        ...
        image1.image=[UIImage imageNamed:@"266"];
    ...
    if (indexPath.section==1) {
        ...
        image2.image=[UIImage imageNamed:@"267"];
    ...
    if (indexPath.section==2) {
        ...
        image2.image=[UIImage imageNamed:@"268"];
        [_tableview addSubview:image2];
    ...
    if (indexPath.section==3) {
        ...
        image3.image=[UIImage imageNamed:@"269"];
    ...
    if (indexPath.section==4) {
        ...
        image4.image=[UIImage imageNamed:@"270"];
    ...
    if (indexPath.section==5) {
        ...
        image5.image=[UIImage imageNamed:@"271"];
