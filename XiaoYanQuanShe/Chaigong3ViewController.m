...
@interface Chaigong3ViewController ()<UITableViewDataSource,UITableViewDelegate>{
...
@implementation Chaigong3ViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.section==0) {
        ...
        image1.image=[UIImage imageNamed:@"153"];
    ...
    if (indexPath.section==1) {
        ...
        image2.image=[UIImage imageNamed:@"154"];
    ...
    if (indexPath.section==2) {
        ...
        image2.image=[UIImage imageNamed:@"155"];
        [_tableview addSubview:image2];
    ...
    if (indexPath.section==3) {
        ...
        image3.image=[UIImage imageNamed:@"156"];
    ...
    if (indexPath.section==4) {
        ...
        image4.image=[UIImage imageNamed:@"157"];
    ...
    if (indexPath.section==5) {
        ...
        image5.image=[UIImage imageNamed:@"158"];
