...
@interface Hamu3ViewController ()<UITableViewDataSource,UITableViewDelegate>{
...
@implementation Hamu3ViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.section==0) {
        ...
        image1.image=[UIImage imageNamed:@"221"];
    ...
    if (indexPath.section==1) {
        ...
        image2.image=[UIImage imageNamed:@"222"];
    ...
    if (indexPath.section==2) {
        ...
        image2.image=[UIImage imageNamed:@"223"];
        [_tableview addSubview:image2];
    ...
    if (indexPath.section==3) {
        ...
        image3.image=[UIImage imageNamed:@"224"];
    ...
    if (indexPath.section==4) {
        ...
        image4.image=[UIImage imageNamed:@"225"];
    ...
    if (indexPath.section==5) {
        ...
        image5.image=[UIImage imageNamed:@"226"];
