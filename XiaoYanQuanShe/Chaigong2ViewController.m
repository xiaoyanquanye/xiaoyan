...
@interface Chaigong2ViewController ()<UITableViewDataSource,UITableViewDelegate>{
...
@implementation Chaigong2ViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.section==0) {
        ...
        image1.image=[UIImage imageNamed:@"139"];
    ...
    if (indexPath.section==1) {
        ...
        image2.image=[UIImage imageNamed:@"140"];
    ...
    if (indexPath.section==2) {
        ...
        image2.image=[UIImage imageNamed:@"141"];
        [_tableview addSubview:image2];
    ...
    if (indexPath.section==3) {
        ...
        image3.image=[UIImage imageNamed:@"142"];
    ...
    if (indexPath.section==4) {
        ...
        image4.image=[UIImage imageNamed:@"143"];
    ...
    if (indexPath.section==5) {
        ...
        image5.image=[UIImage imageNamed:@"144"];
    ...
    if (indexPath.section==6) {
        ...
        image6.image=[UIImage imageNamed:@"145"];
