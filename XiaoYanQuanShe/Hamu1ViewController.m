...
@interface Hamu1ViewController ()<UITableViewDataSource,UITableViewDelegate>{
...
@implementation Hamu1ViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.section==0) {
        ...
        image1.image=[UIImage imageNamed:@"208"];
    ...
    if (indexPath.section==1) {
        ...
        image2.image=[UIImage imageNamed:@"209"];
    ...
    if (indexPath.section==2) {
        ...
        image2.image=[UIImage imageNamed:@"210"];
        [_tableview addSubview:image2];
    ...
    if (indexPath.section==3) {
        ...
        image3.image=[UIImage imageNamed:@"211"];
    ...
    if (indexPath.section==4) {
        ...
        image4.image=[UIImage imageNamed:@"213"];
    ...
    if (indexPath.section==5) {
        ...
        image5.image=[UIImage imageNamed:@"212"];
