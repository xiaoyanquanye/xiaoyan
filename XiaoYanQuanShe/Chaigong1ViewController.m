...
@interface Chaigong1ViewController ()<UITableViewDataSource,UITableViewDelegate>{
...
@implementation Chaigong1ViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.section==0) {
        ...
        image1.image=[UIImage imageNamed:@"146"];
    ...
    if (indexPath.section==1) {
        ...
        image2.image=[UIImage imageNamed:@"147"];
    ...
    if (indexPath.section==2) {
        ...
        image2.image=[UIImage imageNamed:@"148"];
        [_tableview addSubview:image2];
    ...
    if (indexPath.section==3) {
        ...
        image3.image=[UIImage imageNamed:@"149"];
    ...
    if (indexPath.section==4) {
        ...
        image4.image=[UIImage imageNamed:@"150"];
    ...
    if (indexPath.section==5) {
        ...
        image5.image=[UIImage imageNamed:@"151"];
    ...
    if (indexPath.section==6) {
        ...
        image6.image=[UIImage imageNamed:@"152"];
