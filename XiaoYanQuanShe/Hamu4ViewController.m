...
@interface Hamu4ViewController ()<UITableViewDataSource,UITableViewDelegate>{
...
@implementation Hamu4ViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.section==0) {
        ...
        image1.image=[UIImage imageNamed:@"227"];
    ...
    if (indexPath.section==1) {
        ...
        image2.image=[UIImage imageNamed:@"228"];
    ...
    if (indexPath.section==2) {
        ...
        image2.image=[UIImage imageNamed:@"229"];
        [_tableview addSubview:image2];
    ...
    if (indexPath.section==3) {
        ...
        image3.image=[UIImage imageNamed:@"230"];
    ...
    if (indexPath.section==4) {
        ...
        image4.image=[UIImage imageNamed:@"231"];
    ...
    if (indexPath.section==5) {
        ...
        image5.image=[UIImage imageNamed:@"232"];
