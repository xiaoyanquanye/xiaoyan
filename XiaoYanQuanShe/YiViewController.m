...
@interface YiViewController ()<UITableViewDataSource,UITableViewDelegate>{
...
- (void)viewDidLoad {
    ...
    Array=[NSArray arrayWithObjects:[UIImage imageNamed:@"319"],[UIImage imageNamed:@"320"],[UIImage imageNamed:@"321"], [UIImage imageNamed:@"322"],[UIImage imageNamed:@"323"],[UIImage imageNamed:@"324"],[UIImage imageNamed:@"325"],[UIImage imageNamed:@"326"],[UIImage imageNamed:@"327"],[UIImage imageNamed:@"328"],nil];
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section {//页头设计
    ...
    if (section==0) {
        ...
        headerLabel.text=@"出生日期：2017年8月3日                    繁殖者: 倩倩                                 训练师：倩倩                             所有权所在犬舍:潇岩犬舍  ";
