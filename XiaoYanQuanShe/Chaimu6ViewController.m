...
@interface Chaimu6ViewController ()<UITableViewDataSource,UITableViewDelegate>{
...
@implementation Chaimu6ViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.section==0) {
        ...
        image1.image=[UIImage imageNamed:@"195"];
    ...
    if (indexPath.section==1) {
        ...
        image2.image=[UIImage imageNamed:@"199"];
    ...
    if (indexPath.section==2) {
        ...
        image2.image=[UIImage imageNamed:@"196"];
        [_tableview addSubview:image2];
    ...
    if (indexPath.section==3) {
        ...
        image3.image=[UIImage imageNamed:@"200"];
    ...
    if (indexPath.section==4) {
        ...
        image4.image=[UIImage imageNamed:@"197"];
    ...
    if (indexPath.section==5) {
        ...
        image5.image=[UIImage imageNamed:@"198"];
