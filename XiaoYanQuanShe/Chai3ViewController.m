...
@interface Chai3ViewController ()<UITableViewDataSource,UITableViewDelegate>{
...
@implementation Chai3ViewController
...
- (void)viewDidLoad {
    ...
    Array=[NSArray arrayWithObjects:[UIImage imageNamed:@"369"],[UIImage imageNamed:@"370"],[UIImage imageNamed:@"371"], [UIImage imageNamed:@"372"],nil];
