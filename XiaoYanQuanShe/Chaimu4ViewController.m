...
@interface Chaimu4ViewController ()<UITableViewDataSource,UITableViewDelegate>{
...
@implementation Chaimu4ViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.section==0) {
        ...
        image1.image=[UIImage imageNamed:@"175"];
    ...
    if (indexPath.section==1) {
        ...
        image2.image=[UIImage imageNamed:@"176"];
    ...
    if (indexPath.section==2) {
        ...
        image2.image=[UIImage imageNamed:@"177"];
        [_tableview addSubview:image2];
    ...
    if (indexPath.section==3) {
        ...
        image3.image=[UIImage imageNamed:@"178"];
    ...
    if (indexPath.section==4) {
        ...
        image4.image=[UIImage imageNamed:@"179"];
    ...
    if (indexPath.section==5) {
        ...
        image5.image=[UIImage imageNamed:@"180"];
    ...
    if (indexPath.section==6) {
        ...
        image6.image=[UIImage imageNamed:@"188"];
