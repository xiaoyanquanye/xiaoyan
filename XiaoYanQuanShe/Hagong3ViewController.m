...
@interface Hagong3ViewController ()<UITableViewDataSource,UITableViewDelegate>{
...
@implementation Hagong3ViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.section==0) {
        ...
        image1.image=[UIImage imageNamed:@"132"];
    ...
    if (indexPath.section==1) {
        ...
        image2.image=[UIImage imageNamed:@"133"];
    ...
    if (indexPath.section==2) {
        ...
        image2.image=[UIImage imageNamed:@"134"];
        [_tableview addSubview:image2];
    ...
    if (indexPath.section==3) {
        ...
        image3.image=[UIImage imageNamed:@"135"];
    ...
    if (indexPath.section==4) {
        ...
        image4.image=[UIImage imageNamed:@"136"];
    ...
    if (indexPath.section==5) {
        ...
        image5.image=[UIImage imageNamed:@"137"];
    ...
    if (indexPath.section==6) {
        ...
        image6.image=[UIImage imageNamed:@"138"];
