...
@interface Hayou1ViewController ()<UITableViewDataSource,UITableViewDelegate>{
...
@implementation Hayou1ViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.section==0) {
        ...
        image1.image=[UIImage imageNamed:@"252"];
    ...
    if (indexPath.section==1) {
        ...
        image2.image=[UIImage imageNamed:@"253"];
    ...
    if (indexPath.section==2) {
        ...
        image2.image=[UIImage imageNamed:@"254"];
        [_tableview addSubview:image2];
    ...
    if (indexPath.section==3) {
        ...
        image3.image=[UIImage imageNamed:@"255"];
    ...
    if (indexPath.section==4) {
        ...
        image4.image=[UIImage imageNamed:@"256"];
    ...
    if (indexPath.section==5) {
        ...
        image5.image=[UIImage imageNamed:@"257"];
