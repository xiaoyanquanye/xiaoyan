...
@interface Chaimu2ViewController ()<UITableViewDataSource,UITableViewDelegate>{
...
@implementation Chaimu2ViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.section==0) {
        ...
        image1.image=[UIImage imageNamed:@"168"];
    ...
    if (indexPath.section==1) {
        ...
        image2.image=[UIImage imageNamed:@"169"];
    ...
    if (indexPath.section==2) {
        ...
        image2.image=[UIImage imageNamed:@"170"];
        [_tableview addSubview:image2];
    ...
    if (indexPath.section==3) {
        ...
        image3.image=[UIImage imageNamed:@"171"];
    ...
    if (indexPath.section==4) {
        ...
        image4.image=[UIImage imageNamed:@"172"];
    ...
    if (indexPath.section==5) {
        ...
        image5.image=[UIImage imageNamed:@"173"];
    ...
    if (indexPath.section==6) {
        ...
        image6.image=[UIImage imageNamed:@"174"];
