...
@interface Hamu6ViewController ()<UITableViewDataSource,UITableViewDelegate>{
...
@implementation Hamu6ViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.section==0) {
        ...
        image1.image=[UIImage imageNamed:@"240"];
    ...
    if (indexPath.section==1) {
        ...
        image2.image=[UIImage imageNamed:@"241"];
    ...
    if (indexPath.section==2) {
        ...
        image2.image=[UIImage imageNamed:@"242"];
        [_tableview addSubview:image2];
    ...
    if (indexPath.section==3) {
        ...
        image3.image=[UIImage imageNamed:@"243"];
    ...
    if (indexPath.section==4) {
        ...
        image4.image=[UIImage imageNamed:@"244"];
    ...
    if (indexPath.section==5) {
        ...
        image5.image=[UIImage imageNamed:@"245"];
