...
@interface Chaimu5ViewController ()<UITableViewDataSource,UITableViewDelegate>{
...
@implementation Chaimu5ViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.section==0) {
        ...
        image1.image=[UIImage imageNamed:@"189"];
    ...
    if (indexPath.section==1) {
        ...
        image2.image=[UIImage imageNamed:@"190"];
    ...
    if (indexPath.section==2) {
        ...
        image2.image=[UIImage imageNamed:@"191"];
        [_tableview addSubview:image2];
    ...
    if (indexPath.section==3) {
        ...
        image3.image=[UIImage imageNamed:@"192"];
    ...
    if (indexPath.section==4) {
        ...
        image4.image=[UIImage imageNamed:@"193"];
    ...
    if (indexPath.section==5) {
        ...
        image5.image=[UIImage imageNamed:@"194"];
