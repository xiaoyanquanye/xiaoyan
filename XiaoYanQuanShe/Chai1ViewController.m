...
@interface Chai1ViewController ()<UITableViewDataSource,UITableViewDelegate>{
...
@implementation Chai1ViewController
...
- (void)viewDidLoad {
    ...
    Array=[NSArray arrayWithObjects:[UIImage imageNamed:@"360"],[UIImage imageNamed:@"361"],[UIImage imageNamed:@"362"], [UIImage imageNamed:@"363"],nil];
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section {//页头设计
    ...
    if (section==0) {
        ...
        headerLabel.text=@"出生日期：2016年8月3日                    繁殖者: 网易                                 训练师：腾讯                             所有权所在犬舍:潇岩犬舍  ";
