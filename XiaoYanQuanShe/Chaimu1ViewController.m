...
@interface Chaimu1ViewController ()<UITableViewDataSource,UITableViewDelegate>{
...
@implementation Chaimu1ViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.section==0) {
        ...
        image1.image=[UIImage imageNamed:@"159"];
    ...
    if (indexPath.section==1) {
        ...
        image2.image=[UIImage imageNamed:@"160"];
    ...
    if (indexPath.section==2) {
        ...
        image2.image=[UIImage imageNamed:@"161"];
        [_tableview addSubview:image2];
    ...
    if (indexPath.section==3) {
        ...
        image3.image=[UIImage imageNamed:@"162"];
    ...
    if (indexPath.section==4) {
        ...
        image4.image=[UIImage imageNamed:@"163"];
    ...
    if (indexPath.section==5) {
        ...
        image5.image=[UIImage imageNamed:@"164"];
    ...
    if (indexPath.section==6) {
        ...
        image6.image=[UIImage imageNamed:@"165"];
