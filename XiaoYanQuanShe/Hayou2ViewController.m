...
@interface Hayou2ViewController ()<UITableViewDataSource,UITableViewDelegate>{
...
@implementation Hayou2ViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.section==0) {
        ...
        image1.image=[UIImage imageNamed:@"258"];
    ...
    if (indexPath.section==1) {
        ...
        image2.image=[UIImage imageNamed:@"259"];
    ...
    if (indexPath.section==2) {
        ...
        image2.image=[UIImage imageNamed:@"260"];
        [_tableview addSubview:image2];
    ...
    if (indexPath.section==3) {
        ...
        image3.image=[UIImage imageNamed:@"261"];
    ...
    if (indexPath.section==4) {
        ...
        image4.image=[UIImage imageNamed:@"262"];
    ...
    if (indexPath.section==5) {
        ...
        image5.image=[UIImage imageNamed:@"263"];
